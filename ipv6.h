...
int getudp(tcptrace_context_t *context, struct ip *pip, struct udphdr **ppudp, void **pplast);
int getroutingheader(tcptrace_context_t *context, struct ip *pip, struct ipv6_ext **ppipv6_ext, void **pplast);
