...
int realtime_init(tcptrace_context_t *context, int argc, char *argv[]);
void realtime_read(tcptrace_context_t *context, struct ip *pip, tcp_pair *ptp, void *plast, void *pmod_data);
void realtime_done(tcptrace_context_t *context);
...
void *realtime_newconn(tcptrace_context_t *context,  tcp_pair *ptp);
