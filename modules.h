...
struct module {
    ...
    /* I won't.								*/
    int (*module_init) (tcptrace_context_t *context, int argc, char *argv[]);
    ...
    void (*module_done) (tcptrace_context_t *context);
...
extern struct module tcptrace_modules[];   /* in modules_list.c */

int tcptrace_num_modules(void);
